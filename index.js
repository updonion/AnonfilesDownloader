...
bot.on('message', (msg) => {
    ...
    if ((raw_file_size <= 157286400) && (file_status == true)) { // TODO принимать также ссылки типа https://cdn-120.anonfiles.com/RbO4rdT2me/261757a3-1626300234/
        
       async(download_file(`https://anonfiles.com/${file_id}`)) 
        
    } else { bot.sendMessage(chatId, 'Wrong Link or file is too large.'); }
